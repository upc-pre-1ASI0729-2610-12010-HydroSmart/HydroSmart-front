    ...
    <div class="login-page">
      <div class="login-card">
        ...
        <div class="demo-hints">
          ...
          <button class="demo-btn" (click)="fillDemo('admin')">
            {{ i18n.t('login.buildingAdmin') }} — admin&#64;begonias.com.pe
          </button>
          <button class="demo-btn" (click)="fillDemo('tenant')">
            {{ i18n.t('login.resident') }} — arianna.flores&#64;begonias.com.pe
          </button>
        </div>
      </div>
    </div>
...
export class LoginComponent {
  ...
  fillDemo(role: 'admin' | 'tenant'): void {
    if (role === 'admin') {
      this.email = 'admin@begonias.com.pe';
      this.password = 'admin123';
    } else {
      this.email = 'arianna.flores@begonias.com.pe';
