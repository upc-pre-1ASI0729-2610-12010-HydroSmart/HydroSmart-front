...
export class SidebarComponent {
  ...
  private navItems: NavItem[] = [
    { label: 'sidebar.dashboard', route: '/dashboard', icon: 'dashboard',  roles: ['BUILDING_ADMIN', 'TENANT'] },
    { label: 'sidebar.units',     route: '/units',     icon: 'apartment',  roles: ['BUILDING_ADMIN'] },
    { label: 'sidebar.devices',   route: '/devices',   icon: 'sensors',    roles: ['BUILDING_ADMIN'] },
    { label: 'sidebar.reports',   route: '/reports',   icon: 'bar_chart',  roles: ['BUILDING_ADMIN', 'TENANT'] },
    { label: 'sidebar.settings',  route: '/settings',  icon: 'settings',   roles: ['BUILDING_ADMIN'] },
    { label: 'sidebar.profile',   route: '/profile',   icon: 'person',     roles: ['BUILDING_ADMIN', 'TENANT'] },
  ];
  ...
  get userRole(): string {
    const role = this.auth.currentUser()?.role;
    return role === 'BUILDING_ADMIN' ? this.i18n.t('sidebar.admin') : this.i18n.t('sidebar.resident');
  }
